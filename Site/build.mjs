...
const pages = [
  ...
  { source: 'PingWarden/QUICKSTART.md', slug: 'setup', updated: '2026-09-21', title: 'Setup Guide', description: 'Install Ping Warden, activate your license, approve the helper, and verify Ping Protection. Set up Game Mode, latency targets, and Control Center.' },
