...
const pages = [
  ...
  { source: 'PingWarden/README.md', slug: 'technical', updated: '2026-09-25', title: 'Technical Documentation', description: 'How Ping Warden works: AWDL events, the privileged helper, XPC, latency measurement, automation, security, diagnostics, and signed updates.' },
